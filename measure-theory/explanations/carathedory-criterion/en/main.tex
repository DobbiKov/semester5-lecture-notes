...
\begin{document}
\section{Motivation}
This document presents an intuitive explanation of the \emph{Carathéodory Criterion} from measure theory.
...
\begin{figure}[H]
    ...
    \caption{An outer measure of the set $A$ covered by boxes}
