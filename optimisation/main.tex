...
% -----------------------------------------------------------------------
\section{9. Pipeline \& Splits}
\textbf{Data Split:}
\begin{itemize}
    \item \textbf{Train:} Optimize parameters $\theta$.
    \item \textbf{Validation:} Optimize hyper-parameters.
    \item \textbf{Test:} Final performance evaluation.
\end{itemize}
\textbf{Overfitting:} Model learns noise. High score on train, low on validation. Fixes: Regularization, more data.
