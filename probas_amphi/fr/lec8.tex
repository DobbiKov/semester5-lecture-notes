...
Notons $\mathcal{M}_1(\R)$ l'ensemble des mesures de probabilité sur $(\R, \mathcal{B}(\R))$, notons $\mathcal{R}$ l'ensemble des fonction de répartition sur $\R$ (les fonction qui vérifie la \cref{prop:prop-de-fonction-de-repartition})
   ...
   \begin{itemize}
       \item $1) \implies 2)$: Je prends $f(x) = 1_{]-\infty,x]}$, alors
        ...
        \item $2) \implies 1)$: $F_{X_n}(x) \longrightarrow F_X(x)$ en tout
            ...
            \] 
            grâce au thm de convergence dominée.
   \end{itemize} 
