...
Hypothèses: 
\begin{enumerate}[i)]
    \item Les conditions de l'expérience ne changent pas au cours du temps
...
Soit $n\ge 1$ un entier: Nous subdivisons l'axe réel en intervalles de longueur
$\frac{1}{n}$ : $[\frac{k}{n}, \frac{k+1}{n}[$, $k \ge 0$
...
$[\frac{k}{n}, \frac{k+1}{n}[$ soit occupé. Par l'hypothèse $i)$,  $p_n$ ne dépend
pas de l'intervalle.
