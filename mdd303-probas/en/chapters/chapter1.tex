...
Thus, $\mathcal{F} \subset \mathcal{P}(\Omega)$, the set of subsets of $\Omega$. In fact, we require that $\mathcal{F}$ be a tribe or $\sigma$-algebra over $\Omega$.% --- CHUNK_METADATA_START ---
...
\begin{remark}
A tribe necessarily contains $\emptyset$ and $\Omega$.
...
% needs_review: True
% --- CHUNK_METADATA_END ---
\section{Borel tribe}% --- CHUNK_METADATA_START ---
