...
% --- CHUNK_METADATA_END ---
\begin{definition}[Characteristic Function of a Measure $\mu$]
...
% --- CHUNK_METADATA_END ---
\begin{definition}[Characteristic Function of a R.V.]
...
% needs_review: True
% --- CHUNK_METADATA_END ---
\begin{proposition}[Effect of an Affine Transformation]
...
% needs_review: True
% --- CHUNK_METADATA_END ---
\begin{example}[The Gaussian Distribution]
